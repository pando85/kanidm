...
pub enum Attribute {
    ...
    AcpReauthMaxAge,
    AcpRequireReauth,
    AcpReceiverDelegated,
    AcpTargetDelegatedScope,
    DelegatedScopeFilter,
    DelegatedScopeGroup,
    DelegatedBy,
    DelegatedRoleTemplate,
    AcpSearchAttr,
    AcpTargetScope,
    AcpTimeRestrictionStart,
    AcpTimeRestrictionEnd,
    AcpScopeFilter,
    ApiTokenSession,
    ApplicationPassword,
    ApplicationUrl,
    ...
    OAuth2DisplayName,
    OAuth2AutoDiscovery,
    OAuth2LinkLocalAccount,
    OAuth2LinkPolicy,
    OAuth2IdpInitiatedEnabled,
    OAuth2FederationId,
    ObjectClass,
    OtherNoIndex,
    PassKeys,
    ...
    ApprovalState,
    ApprovalDecision,
    ApprovalEscalationLevel,
    ApprovalExpires,
    ApprovalOperationDetails,
...
impl Attribute {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Attribute::AcpReauthMaxAge => ATTR_ACP_REAUTH_MAX_AGE,
            Attribute::AcpRequireReauth => ATTR_ACP_REQUIRE_REAUTH,
            Attribute::AcpReceiverDelegated => ATTR_ACP_RECEIVER_DELEGATED,
            Attribute::AcpTargetDelegatedScope => ATTR_ACP_TARGET_DELEGATED_SCOPE,
            Attribute::DelegatedScopeFilter => ATTR_DELEGATED_SCOPE_FILTER,
            Attribute::DelegatedScopeGroup => ATTR_DELEGATED_SCOPE_GROUP,
            Attribute::DelegatedBy => ATTR_DELEGATED_BY,
            Attribute::DelegatedRoleTemplate => ATTR_DELEGATED_ROLE_TEMPLATE,
            Attribute::AcpSearchAttr => ATTR_ACP_SEARCH_ATTR,
            Attribute::AcpTargetScope => ATTR_ACP_TARGET_SCOPE,
            Attribute::AcpTimeRestrictionStart => ATTR_ACP_TIME_RESTRICTION_START,
            Attribute::AcpTimeRestrictionEnd => ATTR_ACP_TIME_RESTRICTION_END,
            Attribute::AcpScopeFilter => ATTR_ACP_SCOPE_FILTER,
            ...
            Attribute::MaxGrantDuration => ATTR_MAX_GRANT_DURATION,
            Attribute::Member => ATTR_MEMBER,
            Attribute::MemberCreateOnce => ATTR_MEMBER_CREATE_ONCE,
            Attribute::MemberOf => ATTR_MEMBEROF,
            Attribute::MemberValidFrom => ATTR_MEMBER_VALID_FROM,
            Attribute::MemberValidUntil => ATTR_MEMBER_VALID_UNTIL,
            ...
            Attribute::OAuth2EmailDomain => ATTR_OAUTH2_EMAIL_DOMAIN,
            Attribute::OAuth2DisplayName => ATTR_OAUTH2_DISPLAY_NAME,
            Attribute::OAuth2AutoDiscovery => ATTR_OAUTH2_AUTO_DISCOVERY,
            Attribute::OAuth2LinkLocalAccount => ATTR_OAUTH2_LINK_LOCAL_ACCOUNT,
            Attribute::OAuth2LinkPolicy => ATTR_OAUTH2_LINK_POLICY,
            Attribute::OAuth2IdpInitiatedEnabled => ATTR_OAUTH2_IDP_INITIATED_ENABLED,
            Attribute::OAuth2FederationId => ATTR_OAUTH2_FEDERATION_ID,
            ...
            Attribute::TimeBoundedMemberAttr => ATTR_TIME_BOUNDED_MEMBER,
            ...
            Attribute::ApprovalPolicyName => ATTR_APPROVAL_POLICY_NAME,
            Attribute::ApprovalOperationType => ATTR_APPROVAL_OPERATION_TYPE,
            Attribute::ApprovalPatternAttr => ATTR_APPROVAL_PATTERN,
            Attribute::Approver => ATTR_APPROVER,
            Attribute::BackupApprover => ATTR_BACKUP_APPROVER,
            Attribute::ApprovalTimeout => ATTR_APPROVAL_TIMEOUT,
            Attribute::EscalationTimeout => ATTR_ESCALATION_TIMEOUT,
            Attribute::ApprovalPolicyEnabled => ATTR_APPROVAL_POLICY_ENABLED,
            Attribute::ApprovalRequestPolicy => ATTR_APPROVAL_REQUEST_POLICY,
            Attribute::ApprovalTarget => ATTR_APPROVAL_TARGET,
            Attribute::ApprovalRequestor => ATTR_APPROVAL_REQUESTOR,
            Attribute::ApprovalState => ATTR_APPROVAL_STATE,
            Attribute::ApprovalDecision => ATTR_APPROVAL_DECISION,
            Attribute::ApprovalEscalationLevel => ATTR_APPROVAL_ESCALATION_LEVEL,
            Attribute::ApprovalExpires => ATTR_APPROVAL_EXPIRES,
            Attribute::ApprovalOperationDetails => ATTR_APPROVAL_OPERATION_DETAILS,
    ...
    fn inner_from_str(value: &str) -> Self {
        ...
        match value.to_lowercase().as_str() {
            ...
            ATTR_ACP_REAUTH_MAX_AGE => Attribute::AcpReauthMaxAge,
            ATTR_ACP_REQUIRE_REAUTH => Attribute::AcpRequireReauth,
            ATTR_ACP_RECEIVER_DELEGATED => Attribute::AcpReceiverDelegated,
            ATTR_ACP_TARGET_DELEGATED_SCOPE => Attribute::AcpTargetDelegatedScope,
            ATTR_DELEGATED_SCOPE_FILTER => Attribute::DelegatedScopeFilter,
            ATTR_DELEGATED_SCOPE_GROUP => Attribute::DelegatedScopeGroup,
            ATTR_DELEGATED_BY => Attribute::DelegatedBy,
            ATTR_DELEGATED_ROLE_TEMPLATE => Attribute::DelegatedRoleTemplate,
            ATTR_ACP_SEARCH_ATTR => Attribute::AcpSearchAttr,
            ATTR_ACP_TARGET_SCOPE => Attribute::AcpTargetScope,
            ATTR_ACP_TIME_RESTRICTION_START => Attribute::AcpTimeRestrictionStart,
            ATTR_ACP_TIME_RESTRICTION_END => Attribute::AcpTimeRestrictionEnd,
            ATTR_ACP_SCOPE_FILTER => Attribute::AcpScopeFilter,
            ...
            ATTR_MAX_GRANT_DURATION => Attribute::MaxGrantDuration,
            ATTR_MEMBER => Attribute::Member,
            ATTR_MEMBER_CREATE_ONCE => Attribute::MemberCreateOnce,
            ATTR_MEMBEROF => Attribute::MemberOf,
            ATTR_MEMBER_VALID_FROM => Attribute::MemberValidFrom,
            ATTR_MEMBER_VALID_UNTIL => Attribute::MemberValidUntil,
            ...
            ATTR_OAUTH2_EMAIL_DOMAIN => Attribute::OAuth2EmailDomain,
            ATTR_OAUTH2_DISPLAY_NAME => Attribute::OAuth2DisplayName,
            ATTR_OAUTH2_AUTO_DISCOVERY => Attribute::OAuth2AutoDiscovery,
            ATTR_OAUTH2_LINK_LOCAL_ACCOUNT => Attribute::OAuth2LinkLocalAccount,
            ATTR_OAUTH2_LINK_POLICY => Attribute::OAuth2LinkPolicy,
            ATTR_OAUTH2_IDP_INITIATED_ENABLED => Attribute::OAuth2IdpInitiatedEnabled,
            ATTR_OAUTH2_FEDERATION_ID => Attribute::OAuth2FederationId,
            ...
            ATTR_TIME_BOUNDED_MEMBER => Attribute::TimeBoundedMemberAttr,
            ...
            ATTR_APPROVAL_POLICY_NAME => Attribute::ApprovalPolicyName,
            ATTR_APPROVAL_OPERATION_TYPE => Attribute::ApprovalOperationType,
            ATTR_APPROVAL_PATTERN => Attribute::ApprovalPatternAttr,
            ATTR_APPROVER => Attribute::Approver,
            ATTR_BACKUP_APPROVER => Attribute::BackupApprover,
            ATTR_APPROVAL_TIMEOUT => Attribute::ApprovalTimeout,
            ATTR_ESCALATION_TIMEOUT => Attribute::EscalationTimeout,
            ATTR_APPROVAL_POLICY_ENABLED => Attribute::ApprovalPolicyEnabled,
            ATTR_APPROVAL_REQUEST_POLICY => Attribute::ApprovalRequestPolicy,
            ATTR_APPROVAL_TARGET => Attribute::ApprovalTarget,
            ATTR_APPROVAL_REQUESTOR => Attribute::ApprovalRequestor,
            ATTR_APPROVAL_STATE => Attribute::ApprovalState,
            ATTR_APPROVAL_DECISION => Attribute::ApprovalDecision,
            ATTR_APPROVAL_ESCALATION_LEVEL => Attribute::ApprovalEscalationLevel,
            ATTR_APPROVAL_EXPIRES => Attribute::ApprovalExpires,
            ATTR_APPROVAL_OPERATION_DETAILS => Attribute::ApprovalOperationDetails,
