...
pub struct KubidmdCli {
    ...
    #[clap(
        env = "KUBIDM_OTEL_GRPC_ENDPOINT",
        global = true,
        help = "Specify the OpenTelemetry gRPC endpoint (ip/hostname:port)"
    )]
    pub otel_grpc_endpoint: Option<String>,

    #[clap(env = "KUBIDM_DOMAIN", global = true, help = "Specify the domain")]
    pub domain: Option<String>,

    #[clap(env = "KUBIDM_ORIGIN", global = true, help = "Specify the origin URL")]
    pub origin: Option<url::Url>,

    #[clap(env = "KUBIDM_ROLE", global = true, help = "Specify the server role")]
    ...
    #[clap(
        global = true,
        hide = true,
        env = "KUBIDM_TRUST_X_FORWARDED_FOR",
    ...
    #[clap(
        env = "KUBIDM_REPLICATION_BINDADDRESS",
        global = true,
    ...
    #[clap(
        env = "KUBIDM_REPLICATION_TASK_POLL_INTERVAL",
        global = true,
    ...
    #[clap(
        global = true,
        env = "KUBIDM_ONLINE_BACKUP_VERSIONS",
    ...
    #[clap(
        global = true,
        env = "KUBIDM_ONLINE_BACKUP_SCHEDULE",
