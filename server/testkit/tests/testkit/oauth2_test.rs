...
use kubidm_client::ClientError;
use kubidm_client::{http::header, KubidmClient, StatusCode};
...
use kubidmd_lib::idm::oauth2::PkceS256Secret;
...
async fn test_oauth2_openid_basic_flow_mode_unset_bearer(rsclient: &KubidmClient) {
...
#[kubidmd_testkit::test]
async fn test_oauth2_openid_basic_flow_mode_unset_post(rsclient: &KubidmClient) {
    test_oauth2_openid_basic_flow_impl(
        rsclient,
        None,
        false,
...
/// The response should be returned as a query parameter.
#[kubidmd_testkit::test]
async fn test_oauth2_openid_basic_flow_mode_query_bearer(rsclient: &KubidmClient) {
    test_oauth2_openid_basic_flow_impl(
        rsclient,
        Some("query"),
        false,
...
#[kubidmd_testkit::test]
async fn test_oauth2_openid_basic_flow_mode_query_post(rsclient: &KubidmClient) {
    test_oauth2_openid_basic_flow_impl(
        rsclient,
        Some("query"),
        false,
...
#[kubidmd_testkit::test]
async fn test_oauth2_openid_basic_flow_mode_fragment_bearer(rsclient: &KubidmClient) {
    test_oauth2_openid_basic_flow_impl(
        rsclient,
        Some("fragment"),
        true,
...
#[kubidmd_testkit::test]
async fn test_oauth2_openid_basic_flow_mode_fragment_post(rsclient: &KubidmClient) {
    test_oauth2_openid_basic_flow_impl(
        rsclient,
        Some("fragment"),
        true,
...
/// The response should be returned in the URI's fragment.
#[kubidmd_testkit::test]
async fn test_oauth2_openid_basic_flow_no_state_bearer(rsclient: &KubidmClient) {
    test_oauth2_openid_basic_flow_impl(rsclient, Some("fragment"), true, None, AuthMethod::Basic)
        .await;
}
/// The response should be returned in the URI's fragment.
#[kubidmd_testkit::test]
async fn test_oauth2_openid_basic_flow_no_state_post(rsclient: &KubidmClient) {
    test_oauth2_openid_basic_flow_impl(
        rsclient,
        Some("fragment"),
        true,
...
/// The response should be returned as a query parameter.
#[kubidmd_testkit::test]
async fn test_oauth2_openid_public_flow_mode_unset(rsclient: &KubidmClient) {
...
/// The response should be returned as a query parameter.
#[kubidmd_testkit::test]
async fn test_oauth2_openid_public_flow_mode_query(rsclient: &KubidmClient) {
...
/// The response should be returned in the URI's fragment.
#[kubidmd_testkit::test]
async fn test_oauth2_openid_public_flow_mode_fragment(rsclient: &KubidmClient) {
    test_oauth2_openid_public_flow_impl(
        rsclient,
        Some("fragment"),
        true,
...
/// The response should be returned in the URI's fragment.
#[kubidmd_testkit::test]
async fn test_oauth2_openid_public_flow_no_state(rsclient: &KubidmClient) {
    test_oauth2_openid_public_flow_impl(rsclient, Some("fragment"), true, None).await;
}

#[kubidmd_testkit::test]
async fn test_oauth2_token_post_bad_bodies(rsclient: &KubidmClient) {
    let res = rsclient
        .auth_simple_password(ADMIN_TEST_USER, ADMIN_TEST_PASSWORD)
        .await;
    assert!(res.is_ok());
...
#[kubidmd_testkit::test]
async fn test_oauth2_token_revoke_post_bearer(rsclient: &KubidmClient) {
    let res = rsclient
        .auth_simple_password(ADMIN_TEST_USER, ADMIN_TEST_PASSWORD)
        .await;
    assert!(res.is_ok());
...
#[kubidmd_testkit::test]
async fn test_oauth2_token_revoke_post_postauth(rsclient: &KubidmClient) {
    let res = rsclient
        .auth_simple_password(ADMIN_TEST_USER, ADMIN_TEST_PASSWORD)
        .await;
    assert!(res.is_ok());
...
#[kubidmd_testkit::test]
async fn test_oauth2_openid_basic_consent_can_be_disabled(rsclient: &KubidmClient) {
    let res = rsclient
        .auth_simple_password(ADMIN_TEST_USER, ADMIN_TEST_PASSWORD)
        .await;
    assert!(res.is_ok());
...
#[kubidmd_testkit::test]
async fn test_oauth2_openid_public_consent_cant_be_disabled(rsclient: &KubidmClient) {
    let res = rsclient
        .auth_simple_password(ADMIN_TEST_USER, ADMIN_TEST_PASSWORD)
        .await;
    assert!(res.is_ok());
