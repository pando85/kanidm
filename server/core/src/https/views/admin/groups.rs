...
pub(crate) async fn add_member(
    ...
    let old_members_count = if let Some(ScimValueKubidm::EntryReferences(members_before)) =
    ...
    let new_members_count = if let Some(ScimValueKubidm::EntryReferences(members_after)) =
