...
// of these use cases.
pub static BUILTIN_GROUP_SYSTEM_ADMINS_V1: LazyLock<BuiltinGroup> =
...
pub static BUILTIN_GROUP_IDM_ADMINS_V1: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_SERVICE_DESK: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_DOMAIN_ADMINS: LazyLock<BuiltinGroup> = LazyLock::new(|| {
    BuiltinGroup {
        name: "domain_admins",
...
pub static BUILTIN_GROUP_SCHEMA_ADMINS: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_ACCESS_CONTROL_ADMINS: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_PEOPLE_ADMINS: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_PEOPLE_ON_BOARDING: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_PEOPLE_PII_READ: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_PEOPLE_SELF_NAME_WRITE_DL7: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_SERVICE_ACCOUNT_ADMINS: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_OAUTH2_ADMINS: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_RADIUS_SERVICE_ADMINS: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_IDM_RADIUS_SERVERS_V1: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_MAIL_SERVICE_ADMINS_DL8: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_IDM_MAIL_SERVERS_DL8: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_ACCOUNT_POLICY_ADMINS: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_UNIX_ADMINS: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_IDM_UNIX_AUTHENTICATION_READ_V1: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
        name: "idm_unix_authentication_read",
        description:
            "Builtin IDM group allowing service accounts to read and authenticate unix users.",
...
pub static BUILTIN_GROUP_CLIENT_CERTIFICATE_ADMINS_DL7: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static IDM_GROUP_ADMINS_V1: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
/// Self-write of mail
pub static IDM_PEOPLE_SELF_MAIL_WRITE_DL7: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_MESSAGE_ADMINS: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_MESSAGE_SENDERS: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
...
pub static BUILTIN_GROUP_OAUTH2_ACCOUNT_ADMINS: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static IDM_ALL_PERSONS: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
    name: "idm_all_persons",
    description: "Builtin IDM dynamic group containing all persons.",
    uuid: UUID_IDM_ALL_PERSONS,
    members: Vec::with_capacity(0),
    dyngroup: true,
    dyngroup_filter: Some(Filter::And(vec![
...
pub static IDM_ALL_ACCOUNTS: LazyLock<BuiltinGroup> = LazyLock::new(|| BuiltinGroup {
    ...
    members: Vec::with_capacity(0),
    dyngroup: true,
    dyngroup_filter: Some(Filter::Eq(
        Attribute::Class.to_string(),
        EntryClass::Account.to_string(),
    )),
    extra_attributes: vec![
...
pub static IDM_UI_ENABLE_EXPERIMENTAL_FEATURES: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
...
pub static IDM_ACCOUNT_MAIL_READ: LazyLock<BuiltinGroup> = LazyLock::new(|| {
    BuiltinGroup {
...
pub static IDM_HIGH_PRIVILEGE_DL8: LazyLock<BuiltinGroup> = LazyLock::new(|| {
    BuiltinGroup {
...
pub static BUILTIN_GROUP_APPLICATION_ADMINS_DL8: LazyLock<BuiltinGroup> =
    LazyLock::new(|| BuiltinGroup {
