...
pub const UUID_SCHEMA_CLASS_ACCESS_CONTROL_RECEIVER_DELEGATED: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000156");
pub const UUID_SCHEMA_CLASS_ACCESS_CONTROL_TARGET_DELEGATED_SCOPE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000157");
pub const UUID_SCHEMA_CLASS_DELEGATED_ROLE: Uuid = uuid!("00000000-0000-0000-0000-ffff00000158");
...
pub const UUID_SCHEMA_ATTR_DELEGATED_BY: Uuid = uuid!("00000000-0000-0000-0000-ffff00000163");
pub const UUID_SCHEMA_ATTR_DELEGATED_ROLE_TEMPLATE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000164");
