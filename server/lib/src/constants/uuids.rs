...
pub const UUID_ACCOUNT_SIGNUP_FEATURE: Uuid = uuid!("00000000-0000-0000-0000-000000000059");
...
pub const UUID_SCHEMA_ATTR_OAUTH2_ISSUER: Uuid = uuid!("00000000-0000-0000-0000-ffff00000229");
pub const UUID_SCHEMA_ATTR_OAUTH2_JWKS_URI: Uuid = uuid!("00000000-0000-0000-0000-ffff00000230");
pub const UUID_SCHEMA_ATTR_OAUTH2_USERINFO_ENDPOINT: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000231");
pub const UUID_SCHEMA_ATTR_OAUTH2_EMAIL_DOMAIN: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000232");
pub const UUID_SCHEMA_ATTR_OAUTH2_DISPLAY_NAME: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000233");
pub const UUID_SCHEMA_ATTR_OAUTH2_AUTO_DISCOVERY: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000234");
pub const UUID_SCHEMA_ATTR_OAUTH2_LINK_LOCAL_ACCOUNT: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000235");
pub const UUID_SCHEMA_ATTR_OAUTH2_LINK_POLICY: Uuid = uuid!("00000000-0000-0000-0000-ffff00000236");
pub const UUID_SCHEMA_ATTR_OAUTH2_IDP_INITIATED_ENABLED: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000237");
pub const UUID_SCHEMA_ATTR_OAUTH2_FEDERATION_ID: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000238");
pub const UUID_SCHEMA_CLASS_OAUTH2_FEDERATION: Uuid = uuid!("00000000-0000-0000-0000-ffff00000239");
pub const UUID_SCHEMA_CLASS_OAUTH2_LINKED_ACCOUNT: Uuid =
...
pub const UUID_SCHEMA_ATTR_MEMBER_VALID_UNTIL: Uuid = uuid!("00000000-0000-0000-0000-ffff00000301");
pub const UUID_SCHEMA_ATTR_MAX_GRANT_DURATION: Uuid = uuid!("00000000-0000-0000-0000-ffff00000302");
pub const UUID_SCHEMA_CLASS_TIME_BOUNDED_GRANT: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000303");
pub const UUID_SCHEMA_ATTR_TIME_BOUNDED_MEMBER: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000304");

pub const UUID_SCHEMA_ATTR_ACP_REQUIRE_REAUTH: Uuid = uuid!("00000000-0000-0000-0000-ffff00000241");
pub const UUID_SCHEMA_ATTR_ACP_REAUTH_MAX_AGE: Uuid = uuid!("00000000-0000-0000-0000-ffff00000242");

// Delegated Administration Schema
pub const UUID_SCHEMA_CLASS_ACCESS_CONTROL_RECEIVER_DELEGATED: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000243");
pub const UUID_SCHEMA_CLASS_ACCESS_CONTROL_TARGET_DELEGATED_SCOPE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000244");
pub const UUID_SCHEMA_CLASS_DELEGATED_ROLE: Uuid = uuid!("00000000-0000-0000-0000-ffff00000245");
pub const UUID_SCHEMA_ATTR_ACP_RECEIVER_DELEGATED: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000246");
pub const UUID_SCHEMA_ATTR_ACP_TARGET_DELEGATED_SCOPE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000247");
pub const UUID_SCHEMA_ATTR_DELEGATED_SCOPE_FILTER: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000248");
pub const UUID_SCHEMA_ATTR_DELEGATED_SCOPE_GROUP: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000249");
pub const UUID_SCHEMA_ATTR_DELEGATED_BY: Uuid = uuid!("00000000-0000-0000-0000-ffff0000024a");
pub const UUID_SCHEMA_ATTR_DELEGATED_ROLE_TEMPLATE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000024b");

// Fine-Grained Permission Scoping Attributes
pub const UUID_SCHEMA_ATTR_ACP_TIME_RESTRICTION_START: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000025e");
pub const UUID_SCHEMA_ATTR_ACP_TIME_RESTRICTION_END: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000025f");
pub const UUID_SCHEMA_ATTR_ACP_SCOPE_FILTER: Uuid = uuid!("00000000-0000-0000-0000-ffff00000260");

// Approval Workflow Schema UUIDs
pub const UUID_SCHEMA_ATTR_APPROVAL_POLICY_NAME: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000024c");
pub const UUID_SCHEMA_ATTR_APPROVAL_OPERATION_TYPE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000024d");
pub const UUID_SCHEMA_ATTR_APPROVAL_PATTERN: Uuid = uuid!("00000000-0000-0000-0000-ffff0000024e");
pub const UUID_SCHEMA_ATTR_APPROVER: Uuid = uuid!("00000000-0000-0000-0000-ffff0000024f");
pub const UUID_SCHEMA_ATTR_BACKUP_APPROVER: Uuid = uuid!("00000000-0000-0000-0000-ffff00000250");
pub const UUID_SCHEMA_ATTR_APPROVAL_TIMEOUT: Uuid = uuid!("00000000-0000-0000-0000-ffff00000251");
pub const UUID_SCHEMA_ATTR_ESCALATION_TIMEOUT: Uuid = uuid!("00000000-0000-0000-0000-ffff00000252");
pub const UUID_SCHEMA_ATTR_APPROVAL_POLICY_ENABLED: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000253");
pub const UUID_SCHEMA_CLASS_APPROVAL_POLICY: Uuid = uuid!("00000000-0000-0000-0000-ffff00000254");
pub const UUID_SCHEMA_ATTR_APPROVAL_REQUEST_POLICY: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000255");
pub const UUID_SCHEMA_ATTR_APPROVAL_TARGET: Uuid = uuid!("00000000-0000-0000-0000-ffff00000256");
pub const UUID_SCHEMA_ATTR_APPROVAL_REQUESTOR: Uuid = uuid!("00000000-0000-0000-0000-ffff00000257");
pub const UUID_SCHEMA_ATTR_APPROVAL_STATE: Uuid = uuid!("00000000-0000-0000-0000-ffff00000258");
pub const UUID_SCHEMA_ATTR_APPROVAL_DECISION: Uuid = uuid!("00000000-0000-0000-0000-ffff00000259");
pub const UUID_SCHEMA_ATTR_APPROVAL_ESCALATION_LEVEL: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000025a");
pub const UUID_SCHEMA_ATTR_APPROVAL_EXPIRES: Uuid = uuid!("00000000-0000-0000-0000-ffff0000025b");
pub const UUID_SCHEMA_ATTR_APPROVAL_OPERATION_DETAILS: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000025c");
pub const UUID_SCHEMA_CLASS_APPROVAL_REQUEST: Uuid = uuid!("00000000-0000-0000-0000-ffff0000025d");

// Approval Workflow Groups
pub const UUID_IDM_APPROVAL_ADMINS: Uuid = uuid!("00000000-0000-0000-0000-000000000059");
pub const UUID_IDM_APPROVAL_APPROVERS: Uuid = uuid!("00000000-0000-0000-0000-00000000005a");

// Delegated Role Template UUIDs
pub const UUID_IDM_DELEGATED_HELPDESK: Uuid = uuid!("00000000-0000-0000-0000-000000000060");
pub const UUID_IDM_DELEGATED_USER_ADMIN: Uuid = uuid!("00000000-0000-0000-0000-000000000061");
pub const UUID_IDM_DELEGATED_GROUP_ADMIN: Uuid = uuid!("00000000-0000-0000-0000-000000000062");
