...
from kubidm.exceptions import AuthCredFailed, AuthInitFailed
from kubidm.types import AuthBeginResponse
from kubidm.tokens import TokenStore
...
@pytest.mark.network
@pytest.mark.asyncio
async def test_auth_init(client_configfile: KubidmClient) -> None:
...
@pytest.mark.network
@pytest.mark.asyncio
async def test_auth_begin(client_configfile: KubidmClient) -> None:
    ...
    sessionid = result.response.headers["x-kubidm-auth-session-id"]
...
@pytest.mark.network
@pytest.mark.asyncio
async def test_authenticate_flow(client_configfile: KubidmClient) -> None:
...
@pytest.mark.network
@pytest.mark.asyncio
async def test_authenticate_anonymous(client_configfile: KubidmClient) -> None:
    """tests the authenticate() flow"""
...
@pytest.mark.network
@pytest.mark.asyncio
async def test_authenticate_flow_fail(client_configfile: KubidmClient) -> None:
...
# TODO: mock a call to auth_init when "x-kubidm-auth-session-id" not in response.headers, raises ValueError
...
@pytest.mark.asyncio
async def test_authenticate_inputs_validation(client: KubidmClient, mocker: MockerFixture) -> None:
...
@pytest.mark.network
@pytest.mark.asyncio
async def test_auth_step_password(client: KubidmClient) -> None:
    """tests things"""
...
@pytest.mark.network
@pytest.mark.asyncio
async def test_authenticate_with_token(client_configfile: KubidmClient) -> None:
