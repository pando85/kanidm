...
async def test_openapi_status_endpoint(openapi_spec: Mapping[Hashable, Any], openapi_client: KubidmClient) -> None:
...
async def test_openapi_group_list_endpoint(openapi_spec: Mapping[Hashable, Any], openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_scim_application_list_endpoint(
    openapi_spec: Mapping[Hashable, Any],
    openapi_authed_client: KubidmClient,
) -> None:
...
async def test_openapi_scim_application_id_get_endpoint_runtime(openapi_authed_client: KubidmClient) -> None:
