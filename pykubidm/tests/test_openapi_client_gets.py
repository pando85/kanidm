...
async def test_kubidm_client_starts_with_openapi_client(openapi_client: KubidmClient) -> None:
...
async def test_openapi_status_get(openapi_client: KubidmClient) -> None:
    status = await openapi_client.status()
    assert isinstance(status, bool)
    assert status is True


async def test_openapi_check_token_valid_for_authenticated_client(openapi_authed_client: KubidmClient) -> None:
    assert await openapi_authed_client.check_token_valid() is True


async def test_openapi_check_token_valid_for_invalid_explicit_token(openapi_authed_client: KubidmClient) -> None:
    assert await openapi_authed_client.check_token_valid("this-is-not-a-valid-token") is False


async def test_openapi_scim_application_list_get(openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_scim_application_id_get_roundtrip(openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_group_list_get(openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_group_get_by_id_roundtrip(openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_person_list_get(openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_person_get_by_id_roundtrip(openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_oauth2_list_get(openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_service_account_list_get(openapi_authed_client: KubidmClient) -> None:
...
async def test_openapi_service_account_get_by_id_roundtrip(openapi_authed_client: KubidmClient) -> None:
